...
methods.check = async function(message, args, config){
    var username;
    ...
    .then(async message =>{
        let votedList = JSON.parse(fs.readFileSync('./commands/bot/votedout.json'))
        let clownList = JSON.parse(fs.readFileSync('./commands/bot/clowns.json'))
